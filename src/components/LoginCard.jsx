...
export default function LoginCard({ onToggleView, onLoginSuccess }) {
  ...
  return (
    <div className="portal-card">
      ...
      <p className="card-subtitle">Welcome back, Soldier!</p>
      ...
      <div className="social-row">
        <button className="btn-social" aria-label="Sign in with Google" disabled={isLoading}>
          {/* Google Icon */}
        ...
        <button className="btn-social" aria-label="Sign in with Facebook" disabled={isLoading}>
          {/* Facebook Icon */}
          <svg viewBox="0 0 24 24" width="20" height="20">
            <path
              fill="#1877F2"
        ...
        <button className="btn-social" aria-label="Sign in with Twitter" disabled={isLoading}>
          {/* Twitter (X) Icon */}
          <svg viewBox="0 0 24 24" width="20" height="20">
            <path
              fill="#1DA1F2"
        ...
        <button className="btn-social" aria-label="Sign in with Discord" disabled={isLoading}>
          {/* Discord Icon */}
          <svg viewBox="0 0 24 24" width="20" height="20">
            <path
              fill="#5865F2"
